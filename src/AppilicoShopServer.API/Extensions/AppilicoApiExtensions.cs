...
using AppilicoShopServer.API.Swagger;
using AppilicoShopServer.Business.Behaviors;
...
namespace AppilicoShopServer.API.Extensions;
...
public static class AppilicoApiExtensions
{
    ...
    public static WebApplication UseAppilicoPipeline(this WebApplication app)
    {
        ...
        {
            app.UseSwagger();
            app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "AppilicoShopServer API v1"));
        }
    ...
    public static WebApplication MapAppilicoEndpoints(this WebApplication app)
    {
        ...
        {
            service = "AppilicoShopServer API",
            status = "healthy",
            version = "v1",
    ...
    private static IServiceCollection AddApiInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "AppilicoShopServer API",
                Version = "v1",
                Description = "AppilicoShopServer API v1. Routes are stable under /api and use JWT bearer authentication for protected resources."
            });
